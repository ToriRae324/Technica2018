module.exports = function(controller) {
    ...
    controller.hears(["^work advice", "^I need work advice"], 'direct_message,direct_mention', function(bot, message) {
     ...
     //  people advice
     controller.hears(["^people advice", "^I need people advice"], 'direct_message,direct_mention', function(bot, message) {
